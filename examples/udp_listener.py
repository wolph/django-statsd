...
Handy when metrics are not showing up and you want to know whether
django-statsd is sending anything at all:
...
This is the django-statsd copy of the same listener python-statsd ships,
so either one works against either package.
"""
